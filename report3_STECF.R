...
effort_BtS$country <- effort_BtS$country.name
...
plot_stecf <- function(df, type, variable = NULL, cap_year, cap_month, line_count, stecf_report, return_data = FALSE) {
        ...
        #Plot
plot_stecf(effort_BtS,type = "effort", variable= "COUNTRY", "2021","October", 9, "21-10", return_data = FALSE)
...
plot_stecf <- function(df, type, variable = NULL, cap_year, cap_month, line_count, stecf_report, return_data = FALSE) {
        ...
        #Plot
plot_stecf(landings_BtS,type = "landings", variable= "GEAR", "2019","August", 9, "15-23")
ggplot2::ggsave(paste0(cap_year, "_", ecoreg,"_FO_STECF_landings.png"), path = "report/", width = 178, height = 130, units = "mm", dpi = 300)
        #dat
dat <- plot_stecf(landings_BtS, type = "landings", variable="landings", "2019","August", 9, "15-23", return_data = TRUE)
